...
class MainActivity : AppCompatActivity(), PermissionCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mCallApiButton!!.setText(MainActivity.Companion.BUTTON_TEXT)
        ...
        mOutputText!!.text =
            "Click the \'" + MainActivity.Companion.BUTTON_TEXT + "\' button to test the API."
        ...
        mCredential = GoogleAccountCredential.usingOAuth2(
            applicationContext,
            Arrays.asList(*MainActivity.Companion.SCOPES)
        )
     ...
     * appropriate.
     */
    private val resultsFromApi: Void?
        private get() {
     ...
     * is granted.
     */
    @AfterPermissionGranted(MainActivity.Companion.REQUEST_PERMISSION_GET_ACCOUNTS)
    private fun chooseAccount() {
        if (EasyPermissions.hasPermissions(
            ...
            val accountName = getPreferences(Context.MODE_PRIVATE)
                .getString(MainActivity.Companion.PREF_ACCOUNT_NAME, null)
            if (accountName != null) {
                ...
                startActivityForResult(
                    ...
                    MainActivity.Companion.REQUEST_ACCOUNT_PICKER
                )
            }
        } else {
            ...
            EasyPermissions.requestPermissions(
                ...
                MainActivity.Companion.REQUEST_PERMISSION_GET_ACCOUNTS,
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            MainActivity.Companion.REQUEST_GOOGLE_PLAY_SERVICES -> if (resultCode != RESULT_OK) {
                mOutputText!!.text = "This app requires Google Play Services. Please install " +
                        "Google Play Services on your device and relaunch this app."
            } else {
                resultsFromApi
            }
            MainActivity.Companion.REQUEST_ACCOUNT_PICKER -> if (resultCode == RESULT_OK && data != null && data.extras != null
            ) {
                val accountName =
                ...
                if (accountName != null) {
                    ...
                    editor.putString(MainActivity.Companion.PREF_ACCOUNT_NAME, accountName)
                    editor.apply()
                    mCredential!!.selectedAccountName = accountName
                    resultsFromApi
                }
            }
            MainActivity.Companion.REQUEST_AUTHORIZATION -> if (resultCode == RESULT_OK) {
                resultsFromApi
            }
        }
    }
    ...
    fun showGooglePlayServicesAvailabilityErrorDialog(
        ...
        val dialog = apiAvailability.getErrorDialog(
            ...
            MainActivity.Companion.REQUEST_GOOGLE_PLAY_SERVICES
        )
        dialog.show()
    }
...
//        }// Get a list of up to 10 files.
        ...
        override fun onPostExecute(output: List<String?>?) {
            ...
            if (output == null || output.size == 0) {
                ...
                output.toMutableList().add(0, "Data retrieved using the YouTube Data API:")
            ...
            if (mLastError != null) {
                if (mLastError is GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                        ...
                        MainActivity.Companion.REQUEST_AUTHORIZATION
                    )
                } else {
                    mOutputText!!.text = """
